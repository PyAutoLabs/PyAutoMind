...
| 5 | **merged 2026-09-19** — `complete/2026/09/mass-field-sibling-sweep.md` | HowToLens, autolens_assistant | HowToLens's 28 sites migrated in scripts and generated notebooks; chapter-2 prior passing revised; assistant skill/wiki pages migrated. | HowToLens#90 and autolens_assistant#131 merged. |
...
| 7 | **merged 2026-09-19** — `complete/2026/09/mass-field-chaining-helper.md` | PyAutoGalaxy, PyAutoLens | Companion `mass_and_fields_from` carries the top-level field beside mass priors; Lens reexports it. | PyAutoGalaxy#625 and PyAutoLens#745 merged; publication pending. |
| 8 | **merged 2026-09-19** — `complete/2026/09/mass-field-reduce.md`, `complete/2026/09/mass-field-inference-sim.md` | PyAutoReduce, autolens_inference | Two Reduce prototypes and two inference simulators use flat fields. | PyAutoReduce#77 and autolens_inference#8 merged; Reduce publication pending. |
| 9 | **merged 2026-09-19** — `complete/2026/09/mass-field-developer.md` | autolens_workspace_developer | Live JAX, search, plotting, LOS and standalone MGL builders migrated; measurement archives preserved. | autolens_workspace_developer#143 merged from current source `main`; point-source pin drift and legacy examples are recorded in the completion record. |
| 10 | **merged 2026-09-19** — `complete/2026/09/mass-field-inference-slam.md` | autolens_inference | Five-stage SLaM runner field propagation. | autolens_inference#10 merged after its runtime model witness and CI passed. |
| 11 | **merged 2026-09-19** — `complete/2026/09/mass-field-profiling-live.md`, `complete/2026/09/mass-field-pipeline-resume.md` | autolens_profiling | 47 live non-chaining builders and all five staged resume calls migrated; inline witness snapshots preserved. | autolens_profiling#288 and #290 merged; staged consumers use the helper from current source `main`. |
...
- 2026-09-18: **phase 6's sweep completed** — autolens_workspace#562 and autolens_workspace_test#322, both DRAFT pending the PyAutoGalaxy/PyAutoLens PyPI release. Its follow-up audit filed five drafts: the chaining-helper task (now `complete/2026/09/mass-field-chaining-helper.md`; a chained stage had silently dropped the field in `multi_dataset/features/one_by_one/modeling.py`, fixed in #562); `draft/maintenance/autolens_profiling/mass_field_flat_adoption_science_repos.md` (original four-repo survey, now split); the developer workspace sweep (now `complete/2026/09/mass-field-developer.md`); `draft/maintenance/pyautomind/autolens_jax_joss_manifest_gap.md`; and `draft/test/autolens_workspace_test/latent_smoke_assertion_echoes_search_log.md`. **Phase 5 was amended the same day** so HowToLens migrates once, straight to the flat form, rather than twice.
...
- 2026-09-19: phase 9 merged as autolens_workspace_developer#143 (`b2267ce4`) after the human invoked `/prm`; the repository has no configured CI, so the merge used its recorded AST, unit, likelihood and end-to-end validation evidence. Record: `complete/2026/09/mass-field-developer.md`.

## Retired from epics.md (2026-09-19)
...
- status: COMPLETE — all implementation and consumer-migration phases merged 2026-09-19; remaining package publication obligations live in the dated completion records
- ledger: complete/archive/epics/mass_field_epic.md
- notes: PyAutoGalaxy and PyAutoLens provide the standalone `MassField`, flat `fields=` integration, and chaining helper. All live workspace, HowToLens, assistant, Reduce, profiling, inference, and developer consumers in scope have merged; preserved historical witnesses and legacy exclusions are recorded in the ledger. Current source was sufficient for the final consumers, so no release was required to merge them. PyAutoGalaxy#625, PyAutoLens#745, and PyAutoReduce#77 remain tracked for later publication in their dated completion records. The deleted `autolens_jax_joss` checkout was excluded by the human.
