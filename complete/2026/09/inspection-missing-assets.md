...
- merge-commit: 313089812401008f24e710320c78fcd05cf51feb
- Summary: canonical optional-asset handling, regression tests, file-scoped local/RAL deployment and catalogue-only verification complete. All claimed branch commits are ancestors of origin/main.
- Validation: 249 fast tests, 26 missing-asset regressions, CLEAN independent Sol review, both CI runs / all 9 jobs green.
- Authorization: user explicitly authorized development override despite Heart RED, then separately invoked `$prm` for merge. Heart release failure remains; no release or fitting reruns authorized/performed. No library pending-release obligations.
- Evidence retained: /home/jammy/Code/PyAutoLabs/tmp/inspection-missing-assets-issue100-evidence (logs, checksum manifests, rollback preimages, CI inventory).
