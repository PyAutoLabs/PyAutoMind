...
- review-followups: Codex review 2026-09-07 → PyAutoFit#1572 (coupled-transform covariance), #1573 (P1 deterministic-variable covariance, fd path), #1574 (full revert counted as updated; README §3.5 wording); per-variable stale tracking shipped 2026-09-07 (PyAutoFit#1576, record complete/2026/09/ep-stale-tracking-per-variable.md)
- traps: |
