...
- [multistart-quick-update-wiring](2026/09/multistart-quick-update-wiring.md) — `iterations_per_quick_update` / `live_visual_update` are now live for the
