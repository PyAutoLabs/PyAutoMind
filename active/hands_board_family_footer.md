...
`autohands/board.py:313` carries a hard-coded `BOARD_FAMILY` tuple listing five sibling
boards in an ad-hoc order. It predates PyAutoCortex, so the Hands board's
