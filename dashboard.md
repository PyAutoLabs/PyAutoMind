...
<details><summary>📋 <a href="active/profiling_contracts.md">Harden profiling experiment contracts and current result summaries</a> — issued 2026-09-18</summary>

```
/start_dev active/profiling_contracts.md
```
