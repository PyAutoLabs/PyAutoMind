...
| 2026-09-18 | issued | <a href="active/mass_field_bare_fields_slot.md">Accept a bare <code>MassField</code> in <code>fields=</code> so the flat model form works</a> |
...
<details><summary>📋 <a href="draft/research/autolens_profiling/fixed_light_numba_s5_memo_robustness.md">Phase 5: CPU NNLS memo robustness across graded draws</a> — autolens_profiling · large · human-required · high</summary>

```
/start_dev draft/research/autolens_profiling/fixed_light_numba_s5_memo_robustness.md
```
