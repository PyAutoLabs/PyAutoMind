...
<!-- generated by `pyauto-brain intake dashboard --apply` on 2026-09-19 — regenerate, do not hand-edit -->
...
> **Last updated 2026-09-19.** This page is generated from `active/`, `draft/` and the registry files, so it is only as current as they are. `dashboard_refresh.yml` re-renders it on every push to `main` — that heals a stale page, but not a stale prompt: a task that shipped without its prompt advancing to `complete/` keeps rendering here as pickable backlog. Reconciling those is the refresh below.
...
<details><summary>📋 <a href="active/workspace_organs_regroup.md">Group the infrastructure checkouts under organs</a> — <a href="https://github.com/PyAutoLabs/PyAutoBrain/issues/397">issue #397</a> — issued 2026-09-19 — awaiting-merge — PRs: <a href="https://github.com/PyAutoLabs/PyAutoBrain/pull/398">PyAutoBrain#398</a>, <a href="https://github.com/PyAutoLabs/PyAutoMind/pull/420">PyAutoMind#420</a>, <a href="https://github.com/PyAutoLabs/PyAutoHeart/pull/234">PyAutoHeart#234</a>, <a href="https://github.com/PyAutoLabs/PyAutoHands/pull/285">PyAutoHands#285</a>, <a href="https://github.com/PyAutoLabs/PyAutoMemory/pull/100">PyAutoMemory#100</a>, <a href="https://github.com/PyAutoLabs/PyAutoScientist/pull/29">PyAutoScientist#29</a>, <a href="https://github.com/PyAutoLabs/autofit_workspace/pull/159">autofit_workspace#159</a>, <a href="https://github.com/PyAutoLabs/autogalaxy_workspace/pull/245">autogalaxy_workspace#245</a>, <a href="https://github.com/PyAutoLabs/autolens_workspace/pull/567">autolens_workspace#567</a>, <a href="https://github.com/PyAutoLabs/autocti_workspace/pull/32">autocti_workspace#32</a>, <a href="https://github.com/PyAutoLabs/autofit_workspace_test/pull/102">autofit_workspace_test#102</a>, <a href="https://github.com/PyAutoLabs/autogalaxy_workspace_test/pull/124">autogalaxy_workspace_test#124</a>, <a href="https://github.com/PyAutoLabs/autolens_workspace_test/pull/323">autolens_workspace_test#323</a>, <a href="https://github.com/PyAutoLabs/autocti_workspace_test/pull/20">autocti_workspace_test#20</a>, <a href="https://github.com/PyAutoLabs/HowToFit/pull/67">HowToFit#67</a>, <a href="https://github.com/PyAutoLabs/HowToGalaxy/pull/79">HowToGalaxy#79</a>, <a href="https://github.com/PyAutoLabs/HowToLens/pull/88">HowToLens#88</a>, <a href="https://github.com/PyAutoLabs/euclid_strong_lens_modeling_pipeline/pull/91">euclid_strong_lens_modeling_pipeline#91</a></summary>

```
/start_dev active/workspace_organs_regroup.md
```
...
<details><summary>📋 <a href="draft/maintenance/organs/agent_harness_agnostic_setup.md">Make agent setup Claude/Codex agnostic</a> — organs · large · supervised · high</summary>
...
```
You are the judgment tier for the PyAutoMind bundle 'organs — bundle 1' — 2 INDEPENDENT tasks run in one orchestrated session.
...
| Prompt | Difficulty | Priority | Status |
|--------|------------|----------|--------|
| <a href="draft/maintenance/organs/agent_harness_agnostic_setup.md">Make agent setup Claude/Codex agnostic</a> | large | high | draft |
| <a href="draft/maintenance/organs/reduce_session_token_load.md">Reduce the organism's per-session and per-task token load by half</a> | medium | high | draft |
...
| Date | Event | Task |
|------|-------|------|
| 2026-09-19 | issued | <a href="active/workspace_organs_regroup.md">Group the infrastructure checkouts under organs</a> |
...
<details><summary>📋 <a href="draft/docs/workspaces/mass_field_sibling_sweep.md">MassField sibling sweep: HowToLens and autolens_assistant move straight to the flat <code>fields=</code></a> — workspaces · medium · safe · low</summary>
...
<details><summary>📋 <a href="draft/feature/autogalaxy/mass_from_grows_a_fields_argument.md"><code>mass_from</code> grows a <code>fields</code> argument so a chained stage cannot silently drop…</a> — autogalaxy · medium · supervised · normal</summary>

```
/start_dev draft/feature/autogalaxy/mass_from_grows_a_fields_argument.md
```
