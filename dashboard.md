...
<!-- generated by `pyauto-brain intake dashboard --apply` on 2026-09-23 — regenerate, do not hand-edit -->
...
> **Last updated 2026-09-23.** This page is generated from `active/`, `draft/` and the registry files, so it is only as current as they are. `dashboard_refresh.yml` re-renders it on every push to `main` — that heals a stale page, but not a stale prompt: a task that shipped without its prompt advancing to `complete/` keeps rendering here as pickable backlog. Reconciling those is the refresh below.
...
<details><summary>📋 <a href="active/pointsolver_image_plane_chi_squared_cpu_speed.md">Point-source CPU speed-up campaign: shared breakdown, redundant-sort removal and measured iteration</a> — <a href="https://github.com/PyAutoLabs/autolens_profiling/issues/297">issue #297</a> — issued 2026-09-23 — workspace-dev</summary>

```
/start_dev active/pointsolver_image_plane_chi_squared_cpu_speed.md
```
...
**212** filed prompts, not started. Each section is sorted most-pickable first (priority, then size). **37** of them belong to an epic and are listed only under [Epics](#epics) below.
...
| Date | Event | Task |
|------|-------|------|
| 2026-09-23 | issued | <a href="active/pointsolver_image_plane_chi_squared_cpu_speed.md">Point-source CPU speed-up campaign: shared breakdown, redundant-sort…</a> |
| 2026-09-23 | issued | <a href="active/implement_and_optimize_certified_positive_solver.md">Implement and optimize certified positive solver with structure-aware…</a> |
...
<details><summary>📋 <a href="draft/research/autolens_profiling/certified_solver_production_default.md">Certified positive solver — production default and batched (vmap) policy (phase B)</a> — autolens_profiling · large · supervised · high</summary>

```
/start_dev draft/research/autolens_profiling/certified_solver_production_default.md
```
...
- `draft/research/autolens_profiling/certified_solver_production_default.md — unknown theme keyword(s): inversion`
