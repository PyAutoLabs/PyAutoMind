...
<details><summary>📋 <a href="active/status_sh_repos_missing_source.md">status.sh --repos sources a file that no longer exists</a> — <a href="https://github.com/PyAutoLabs/PyAutoMind/issues/331">issue #331</a> — issued 2026-08-26 — infra-dev — Mind infrastructure (neither library nor workspace)</summary>

```
/start_dev active/status_sh_repos_missing_source.md
```
...
| Date | Event | Task |
|------|-------|------|
| 2026-08-26 | issued | <a href="active/status_sh_repos_missing_source.md">status.sh --repos sources a file that no longer exists</a> |
