...
<details><summary>📋 <a href="active/ep_full_revert_not_updated.md">A fully reverted projection still reports <code>updated=True</code>, suppressing the STALE FACTORS warning</a> — issued 2026-09-07</summary>

```
/start_dev active/ep_full_revert_not_updated.md
```

</details>

<details><summary>📋 <a href="active/ep_laplace_deterministic_hessian.md">Laplace fd-Hessian path leaves deterministic variables at their cavity covariance</a> — issued 2026-09-07</summary>

```
/start_dev active/ep_laplace_deterministic_hessian.md
```
...
<details><summary>📋 <a href="active/transformed_from_mode_coupled_covariance.md"><code>TransformedMessage.from_mode</code> diagonalises an operator covariance before a coupled Jacobian</a> — issued 2026-09-07</summary>

```
/start_dev active/transformed_from_mode_coupled_covariance.md
```
...
| Date | Event | Task |
|------|-------|------|
| 2026-09-07 | issued | <a href="active/transformed_from_mode_coupled_covariance.md"><code>TransformedMessage.from_mode</code> diagonalises an operator covariance…</a> |
| 2026-09-07 | issued | <a href="active/ep_laplace_deterministic_hessian.md">Laplace fd-Hessian path leaves deterministic variables at their…</a> |
...
| 2026-09-07 | issued | <a href="active/ep_full_revert_not_updated.md">A fully reverted projection still reports <code>updated=True</code>, suppressing…</a> |
