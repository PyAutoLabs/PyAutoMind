...
<details><summary>📋 <a href="draft/docs/workspaces/interferometer_pixelization_examples_linear_bulg.md">Interferometer pixelization examples: linear bulge + pixelization hybrid on the sparse path</a> — workspaces · small · supervised · normal</summary>

```
/start_dev draft/docs/workspaces/interferometer_pixelization_examples_linear_bulg.md
```
