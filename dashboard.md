...
<details><summary>📋 <a href="draft/maintenance/pyautobrain/fix_wiki_currency_ci_drift_in_the.md">Fix wiki-currency CI drift in the lens and galaxy assistants</a> — pyautobrain · small · safe · medium</summary>

```
/start_dev draft/maintenance/pyautobrain/fix_wiki_currency_ci_drift_in_the.md
```
...
<details><summary>📋 <a href="active/science_project_memory_a_fresh_chat_pointed.md">Science-project memory: a fresh chat pointed at a project folder resumes…</a> — <a href="https://github.com/PyAutoLabs/PyAutoBrain/issues/315">issue #315</a> — issued 2026-08-28 — 3 of 5 PRs merged; 2 open on a pre-existing CI red (see library-pr below)</summary>
