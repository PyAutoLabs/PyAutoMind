...
<details><summary>📋 <a href="draft/research/autolens_profiling/hst_gpu_residue_p3_psf_cube.md">HST GPU residue phase 3 — the PSF convolution of the mapping-matrix…</a> — autolens_profiling · large · supervised · high</summary>

```
/start_dev draft/research/autolens_profiling/hst_gpu_residue_p3_psf_cube.md
```
...
- `draft/research/autolens_profiling/hst_gpu_residue_p3_psf_cube.md — unknown theme keyword(s): inversion`
