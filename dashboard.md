...
<details><summary>📋 <a href="active/sparse_interferometer_docs_sweep.md">Interferometer docs sweep: sparse operator now supports linear light profiles + pixelizations</a> — <a href="https://github.com/PyAutoLabs/autolens_workspace/issues/508">issue #508</a> — issued 2026-08-28 — workspace-dev</summary>

```
/start_dev active/sparse_interferometer_docs_sweep.md
```
...
| 2026-08-28 | issued | <a href="active/sparse_interferometer_docs_sweep.md">Interferometer docs sweep: sparse operator now supports linear light…</a> |
