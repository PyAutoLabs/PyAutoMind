...
<details><summary>📋 <a href="draft/feature/autoarray/delaunay_walk_early_exit_unchunked.md">JAX Delaunay point location: early-exit walk, unchunked loop, static image-plane seed</a> — autoarray · medium · supervised · high</summary>
...
<details><summary>📋 <a href="draft/bug/autolens_workspace_test/jax_grad_delaunay_fd_sweep_repin.md">imaging/jax_grad/delaunay.py: FD step sweep sits in the round-off floor on mass.ell_comps_0 after…</a> — autolens_workspace_test · easy · supervised · high</summary>

```
/start_dev draft/bug/autolens_workspace_test/jax_grad_delaunay_fd_sweep_repin.md
```
...
Members:
- draft/bug/autolens_workspace_test/jax_grad_delaunay_fd_sweep_repin.md
...
|--------|------------|----------|--------|
| <a href="draft/bug/autolens_workspace_test/jax_grad_delaunay_fd_sweep_repin.md">imaging/jax_grad/delaunay.py: FD step sweep sits in the round-off…</a> | easy | high | draft |
...
- draft/feature/autoarray/delaunay_walk_early_exit_unchunked.md
...
| <a href="draft/feature/autoarray/delaunay_walk_early_exit_unchunked.md">JAX Delaunay point location: early-exit walk, unchunked loop, static…</a> | autoarray | medium | high | draft |
...
| Date | Event | Task |
|------|-------|------|
| 2026-09-07 | filed | <a href="draft/bug/autolens_workspace_test/jax_grad_delaunay_fd_sweep_repin.md">imaging/jax_grad/delaunay.py: FD step sweep sits in the round-off…</a> |
...
- `draft/feature/autoarray/delaunay_walk_early_exit_unchunked.md — unknown theme keyword(s): jax-gpu, delaunay, performance`
