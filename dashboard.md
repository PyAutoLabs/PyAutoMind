...
<details><summary>📋 <a href="active/custom_output_roots_are_never_pulled_from.md">Custom output roots are never pulled from the HPC — each project's…</a> — issued 2026-09-09</summary>
...
| Date | Event | Task |
|------|-------|------|
| 2026-09-09 | issued | <a href="active/custom_output_roots_are_never_pulled_from.md">Custom output roots are never pulled from the HPC — each project's…</a> |
