...
<details><summary>📋 <a href="draft/refactor/workspaces/give_the_orphan_mgl_slam_batch_py.md">Give the orphan mgl_slam_batch.py a home and sweep its lp bins</a> — workspaces · easy · supervised · normal</summary>

```
/start_dev draft/refactor/workspaces/give_the_orphan_mgl_slam_batch_py.md
```
