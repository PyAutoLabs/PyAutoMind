...
**163** filed prompts, not started. Each section is sorted most-pickable first (priority, then size). **47** of them belong to an epic and are listed only under [Epics](#epics) below.
...
| Date | Event | Task |
|------|-------|------|
| 2026-09-03 | issued | <a href="active/numpy_deflections_p3_closed_form_geometry.md">Numpy deflections phase 3: PowerLaw series with factor-driven term…</a> |
