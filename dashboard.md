...
<!-- generated by `pyauto-brain intake dashboard --apply` on 2026-09-20 — regenerate, do not hand-edit -->
...
> **Last updated 2026-09-20.** This page is generated from `active/`, `draft/` and the registry files, so it is only as current as they are. `dashboard_refresh.yml` re-renders it on every push to `main` — that heals a stale page, but not a stale prompt: a task that shipped without its prompt advancing to `complete/` keeps rendering here as pickable backlog. Reconciling those is the refresh below.
...
<details><summary>📋 <a href="active/hst_gpu_residue_p2_vmap_vs_jit_and_batched_callback.md">HST GPU residue phase 2 — vmap vs jit for the production…</a> — <a href="https://github.com/PyAutoLabs/autolens_profiling/issues/273">issue #273</a> — issued 2026-09-16 — awaiting-merge — PRs: <a href="https://github.com/PyAutoLabs/autolens_profiling/pull/294">autolens_profiling#294</a></summary>
...
<details><summary>📋 <a href="active/remove_empty_modeling_headings.md">Remove empty modeling headings from workspace examples</a> — <a href="https://github.com/PyAutoLabs/autolens_workspace/issues/574">issue #574</a> — issued 2026-09-20 — workspace-shipped, ready-for-merge — PRs: <a href="https://github.com/PyAutoLabs/autolens_workspace/pull/575">autolens_workspace#575</a></summary>

```
/start_dev active/remove_empty_modeling_headings.md
```
