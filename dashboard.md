...
<!-- generated by `pyauto-brain intake dashboard --apply` on 2026-09-18 — regenerate, do not hand-edit -->
...
> **Last updated 2026-09-18.** This page is generated from `active/`, `draft/` and the registry files, so it is only as current as they are. `dashboard_refresh.yml` re-renders it on every push to `main` — that heals a stale page, but not a stale prompt: a task that shipped without its prompt advancing to `complete/` keeps rendering here as pickable backlog. Reconciling those is the refresh below.
...
- ⏸ waiting: [autolens_workspace + autolens_workspace_test: adopt the flat (bare) <code>fields=</code> form](active/mass_field_flat_sweep.md)
...
<details><summary>📋 <a href="draft/maintenance/pyautobrain/workspace_location_contracts.md">Workspace location contracts: one resolver for root, repo, main and task checkouts</a> — pyautobrain · large · supervised · high</summary>

```
/start_dev draft/maintenance/pyautobrain/workspace_location_contracts.md
```
...
<details><summary>📋 <a href="draft/maintenance/pyautobrain/workspace_dead_weight_cleanup.md">Workspace dead-weight cleanup and autolens_jax_joss local removal</a> — pyautobrain · small · supervised · normal</summary>

```
/start_dev draft/maintenance/pyautobrain/workspace_dead_weight_cleanup.md
```

</details>

<details><summary>📋 <a href="draft/maintenance/pyautomind/autolens_jax_joss_manifest_gap.md"><code>autolens_jax_joss</code> is missing from the body map, and <code>repos_sync.py</code> structurally cannot see…</a> — pyautomind · small · safe · normal</summary>

```
/start_dev draft/maintenance/pyautomind/autolens_jax_joss_manifest_gap.md
```
...
Members:
- draft/maintenance/pyautobrain/workspace_location_contracts.md
...
- draft/maintenance/pyautobrain/workspace_dead_weight_cleanup.md
...
| Prompt | Difficulty | Priority | Status |
|--------|------------|----------|--------|
| <a href="draft/maintenance/pyautobrain/workspace_location_contracts.md">Workspace location contracts: one resolver for root, repo, main and…</a> | large | high | formalised |
...
| <a href="draft/maintenance/pyautobrain/workspace_dead_weight_cleanup.md">Workspace dead-weight cleanup and autolens_jax_joss local removal</a> | small | normal | formalised |
...
| 2026-09-18 | filed | <a href="draft/maintenance/pyautomind/autolens_jax_joss_manifest_gap.md"><code>autolens_jax_joss</code> is missing from the body map, and <code>repos_sync.py</code>…</a> |
