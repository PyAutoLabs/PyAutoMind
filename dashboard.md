...
| Date | Event | Task |
|------|-------|------|
| 2026-09-16 | issued | <a href="active/hst_gpu_residue_p1_trace_decomposition.md">HST GPU residue phase 1 — a trace-based, one-process decomposition…</a> |
...
<details><summary>📋 <a href="draft/bug/euclid/pixelized_source_clumps_empty_on_real_dr1.md"><code>wcs.json</code> records no pixelized-source clumps on real DR1 lenses — the clump…</a> — euclid · medium · supervised · high</summary>

```
/start_dev draft/bug/euclid/pixelized_source_clumps_empty_on_real_dr1.md
```
...
- `draft/bug/euclid/pixelized_source_clumps_empty_on_real_dr1.md — unknown theme keyword(s): euclid, source-reconstruction`
