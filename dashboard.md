...
**138** filed prompts, not started. Each section is sorted most-pickable first (priority, then size). **27** of them belong to an epic and are listed only under [Epics](#epics) below.
...
<details>
<summary><b>none (successor to numba-cpu-likelihood, COMPLETE 2026-08-28)</b> — 1 queued prompt(s) — ⚠️ not in `epics.md`</summary>

<details><summary>📋 <a href="draft/feature/autoarray/numba_cpu_hst_curvature_matrix_speedup.md">Numba CPU likelihood at HST resolution: speed up the curvature matrix F…</a> — autoarray · large · supervised · high</summary>

```
/start_dev draft/feature/autoarray/numba_cpu_hst_curvature_matrix_speedup.md
```
...
<details>
<summary><b>inference-programme</b> — 1 queued prompt(s) — ⚠️ not in `epics.md`</summary>

<details><summary>📋 <a href="draft/feature/autolens_profiling/nuts_warm_start_driver_and_a100_probe.md">NUTS warm-start driver + A100 MCMC probe (and an SMC research row)</a> — autolens_profiling · medium · supervised · high</summary>

```
/start_dev draft/feature/autolens_profiling/nuts_warm_start_driver_and_a100_probe.md
```
...
- `draft/feature/autolens_profiling/nuts_warm_start_driver_and_a100_probe.md — unknown theme keyword(s): inference, jax, hpc`
