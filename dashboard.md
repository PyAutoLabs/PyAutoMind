...
**154** filed prompts, not started. Each section is sorted most-pickable first (priority, then size). **31** of them belong to an epic and are listed only under [Epics](#epics) below.
...
| Date | Event | Task |
|------|-------|------|
| 2026-09-06 | issued | <a href="active/smoke_ci_caches_jax_datasets.md">CI caches in the reusable smoke workflow: JAX compile cache + dataset…</a> |
