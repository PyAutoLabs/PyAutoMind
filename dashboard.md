...
<!-- generated by `pyauto-brain intake dashboard --apply` on 2026-09-09 — regenerate, do not hand-edit -->
...
> **Last updated 2026-09-09.** This page is generated from `active/`, `draft/` and the registry files, so it is only as current as they are. `dashboard_refresh.yml` re-renders it on every push to `main` — that heals a stale page, but not a stale prompt: a task that shipped without its prompt advancing to `complete/` keeps rendering here as pickable backlog. Reconciling those is the refresh below.
...
<details><summary>📋 <a href="active/ch4_mask_overlay_never_drawn.md">HowToLens ch4 tutorial 3: mask overlay is never actually drawn</a> — <a href="https://github.com/PyAutoLabs/HowToLens/issues/78">issue #78</a> — issued 2026-09-09 — awaiting-merge — PRs: <a href="https://github.com/PyAutoLabs/HowToLens/pull/79">HowToLens#79</a></summary>

```
/start_dev active/ch4_mask_overlay_never_drawn.md
```
...
<details><summary>📋 <a href="active/scientific_workflow_language.md">Scientific workflow through natural language</a> — issued 2026-09-09</summary>

```
/start_dev active/scientific_workflow_language.md
```
...
| Prompt | Difficulty | Priority | Status |
|--------|------------|----------|--------|
| <a href="draft/bug/autoarray/mapper_adapt_zero_signal_jax_nan.md">Adapt-density mapper: a zero-signal adapt image is NaN on the JAX…</a> | small | medium | formalised |
...
| Date | Event | Task |
|------|-------|------|
| 2026-09-09 | issued | <a href="active/scientific_workflow_language.md">Scientific workflow through natural language</a> |
| 2026-09-09 | issued | <a href="active/smoke_relevance_gate.md">Relevance-gate the reusable smoke workflow so a PR only runs…</a> |
| 2026-09-09 | issued | <a href="active/mge_jit_regression_rebaseline.md">Re-baseline the MGE imaging JIT profiling regression value</a> |
...
| 2026-09-09 | issued | <a href="active/ch4_mask_overlay_never_drawn.md">HowToLens ch4 tutorial 3: mask overlay is never actually drawn</a> |
| 2026-09-09 | issued | <a href="active/scheduled_runs_delivered_hours_late.md">Every scheduled workflow is delivered hours late, or not at all</a> |
