...
<details><summary>📋 <a href="active/fixed_light_numba_phase2_source_only_solver.md">Numba phase 2 — source-only solve on the numba CPU path: measure…</a> — <a href="https://github.com/PyAutoLabs/autolens_profiling/issues/265">issue #265</a> — issued 2026-09-15 — workspace-dev</summary>

```
/start_dev active/fixed_light_numba_phase2_source_only_solver.md
```
