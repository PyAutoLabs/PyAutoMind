...
<details><summary>📋 <a href="active/quick_update_out_of_disk_ell_comps_kills_run.md">A quick update must not kill a 36 h run because…</a> — issued 2026-09-07</summary>

```
/start_dev active/quick_update_out_of_disk_ell_comps_kills_run.md
```
...
| 2026-09-07 | issued | <a href="active/quick_update_out_of_disk_ell_comps_kills_run.md">A quick update must not kill a 36 h run because…</a> |
