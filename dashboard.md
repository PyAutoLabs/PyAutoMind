...
<details><summary>📋 <a href="active/point_solver_magnification_filter_ignores_plane_redshift.md">PointSolver magnification filter ignores plane_redshift</a> — <a href="https://github.com/PyAutoLabs/PyAutoLens/issues/480">issue #480</a> — issued 2026-08-27 — library-dev</summary>

```
/start_dev active/point_solver_magnification_filter_ignores_plane_redshift.md
```
...
| Date | Event | Task |
|------|-------|------|
| 2026-08-27 | issued | <a href="active/point_solver_magnification_filter_ignores_plane_redshift.md">PointSolver magnification filter ignores plane_redshift</a> |
