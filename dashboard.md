...
**169** filed prompts, not started. Each section is sorted most-pickable first (priority, then size). **62** of them belong to an epic and are listed only under [Epics](#epics) below.
...
<details>
<summary><b>PyAutoCortex — the science organ: split science runs out of the Mind</b> — 7 queued prompt(s), in order</summary>
