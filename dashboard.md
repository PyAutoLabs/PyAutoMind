...
<!-- generated by `pyauto-brain intake dashboard --apply` on 2026-09-02 — regenerate, do not hand-edit -->
...
> **Last updated 2026-09-02.** This page is generated from `active/`, `draft/` and the registry files, so it is only as current as they are. `dashboard_refresh.yml` re-renders it on every push to `main` — that heals a stale page, but not a stale prompt: a task that shipped without its prompt advancing to `complete/` keeps rendering here as pickable backlog. Reconciling those is the refresh below.
...
<details><summary>📋 <a href="draft/research/autogalaxy/jax_faddeeva_seams_and_spherical_clamp_audit.md">Audit the JAX-path Faddeeva approximation and the spherical axis-ratio clamp in MGE…</a> — autogalaxy · medium · supervised · medium</summary>

```
/start_dev draft/research/autogalaxy/jax_faddeeva_seams_and_spherical_clamp_audit.md
```
...
<details><summary>📋 <a href="active/ep_prior_id_zero_collides_with_factor_value.md">EP: the first prior of a process (id 0) collides…</a> — <a href="https://github.com/PyAutoLabs/PyAutoFit/issues/1557">issue #1557</a> — issued 2026-09-02 — library-dev</summary>
...
<details><summary>📋 <a href="active/numpy_deflections_p2_mge_wofz.md">Numpy deflections phase 2: MGE / Faddeeva — scipy wofz on numpy…</a> — <a href="https://github.com/PyAutoLabs/PyAutoGalaxy/issues/596">issue #596</a> — issued 2026-09-02 — library-dev</summary>
...
**167** filed prompts, not started. Each section is sorted most-pickable first (priority, then size). **50** of them belong to an epic and are listed only under [Epics](#epics) below.
...
<details>
<summary><b>numba-cpu · profiling</b> — 2 task(s) · 5 pts · auto — proposed — ⚠️ theme(s) not in `themes.md`: jax, mass-profiles</summary>

<details><summary>📋 <b>Run this bundle</b> — one session, one issue and one PR per member</summary>

```
You are the architect (Fable) for the PyAutoMind bundle 'numba-cpu · profiling' — 2 INDEPENDENT tasks run in one orchestrated session.
...
| Prompt | Repo | Difficulty | Priority | Status |
|--------|------|------------|----------|--------|
| <a href="draft/feature/autogalaxy/precompute_fixed_geometry_gaussian_deflections.md">Precompute fixed-geometry Gaussian deflection angles and rescale by…</a> | autogalaxy | large | medium | formalised |
| <a href="draft/feature/autolens_profiling/numba_breakdown_harness_memo_blind.md">Numba breakdown harness: perturb the instance so the operated-matrix…</a> | autolens_profiling | small | medium | formalised |
...
| 2026-09-02 | issued | <a href="active/batch_review_integration_branches_p3_push.md">Batch review integration branches phase 3: --push, never-force…</a> |
| 2026-09-02 | filed | <a href="draft/research/autogalaxy/jax_faddeeva_seams_and_spherical_clamp_audit.md">Audit the JAX-path Faddeeva approximation and the spherical…</a> |
...
<details>
<summary><b>Euclid DR1 preparation — 15k-lens modelling prep</b> — 4 queued prompt(s), in order</summary>
...
<details>
<summary><b>Numpy (CPU) deflection angles — nine mass profiles on the numba route</b> — 2 queued prompt(s), in order</summary>

<details><summary>📋 <b>Numpy (CPU) deflection angles — nine mass profiles on the numba route</b> — ledger: `draft/feature/autogalaxy/numpy_deflections_cpu_speedup.md` — phase 1 SHIPPED 2026-09-02 (record complete/2026/09/numpy-deflections-p1.md); phase 2 next</summary>
...
- `draft/research/autogalaxy/jax_faddeeva_seams_and_spherical_clamp_audit.md — unknown theme keyword(s): jax, mass-profiles`
