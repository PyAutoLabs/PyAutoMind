...
<details><summary>📋 <a href="draft/maintenance/config/remove_fits_dataset_from_remaining_plots_yaml_copies.md">Remove the dead <code>fits_dataset</code> key from the remaining <code>config/visualize/plots.yaml</code> copies</a> — config · trivial · safe · low</summary>

```
/start_dev draft/maintenance/config/remove_fits_dataset_from_remaining_plots_yaml_copies.md
```

</details>

<details><summary>📋 <a href="draft/feature/autofit/aggregator_temporary_unzip.md">Aggregator: temporary-directory unzip mode so scraping <code>.zip</code> results does not permanently double…</a> — autofit · small · supervised · medium</summary>
...
<details><summary>📋 <a href="active/remove_the_two_fold_label_degeneracy_in.md">Remove the two-fold label degeneracy in the Euclid lens-light MGE model</a> — <a href="https://github.com/PyAutoLabs/euclid_strong_lens_modeling_pipeline/issues/54">issue #54</a> — issued 2026-09-08 — awaiting-merge — PRs: <a href="https://github.com/PyAutoLabs/euclid_strong_lens_modeling_pipeline/pull/55">euclid_strong_lens_modeling_pipeline#55</a></summary>

```
/start_dev active/remove_the_two_fold_label_degeneracy_in.md
```

</details>

<details><summary>📋 <a href="active/replace_metadata_sentinel_with_search_json.md">Remove the output-folder <code>metadata</code> file; aggregator discovers searches via <code>files/search.json</code></a> — <a href="https://github.com/PyAutoLabs/PyAutoFit/issues/1582">issue #1582</a> — issued 2026-09-08 — library-shipped, workspace-shipped, awaiting-merge — PRs: <a href="https://github.com/PyAutoLabs/PyAutoFit/pull/1585">PyAutoFit#1585</a>, <a href="https://github.com/PyAutoLabs/autofit_workspace_test/pull/101">autofit_workspace_test#101</a>, <a href="https://github.com/PyAutoLabs/autolens_workspace_developer/pull/133">autolens_workspace_developer#133</a></summary>

```
/start_dev active/replace_metadata_sentinel_with_search_json.md
```
...
<details><summary>📋 <a href="active/traced_assertions_on_jax_path.md">Make <code>add_assertion</code> enforceable on the JAX likelihood path</a> — <a href="https://github.com/PyAutoLabs/PyAutoFit/issues/1581">issue #1581</a> — issued 2026-09-08 — awaiting-merge — PRs: <a href="https://github.com/PyAutoLabs/PyAutoFit/pull/1583">PyAutoFit#1583</a>, <a href="https://github.com/PyAutoLabs/autofit_workspace_test/pull/100">autofit_workspace_test#100</a> — ⏳ pending release: PyAutoFit</summary>
...
- [PyAutoArray#541](https://github.com/PyAutoLabs/PyAutoArray/pull/541) — `active/interferometer_preload_prose_nufft.md`
...
- [PyAutoFit#1583](https://github.com/PyAutoLabs/PyAutoFit/pull/1583) — `active/traced_assertions_on_jax_path.md`
...
**160** filed prompts, not started. Each section is sorted most-pickable first (priority, then size). **28** of them belong to an epic and are listed only under [Epics](#epics) below.
...
Members:
- draft/feature/autofit/aggregator_temporary_unzip.md
...
|--------|------------|----------|--------|
| <a href="draft/feature/autofit/aggregator_temporary_unzip.md">Aggregator: temporary-directory unzip mode so scraping <code>.zip</code> results…</a> | small | medium | formalised |
...
| 2026-09-08 | issued | <a href="active/replace_metadata_sentinel_with_search_json.md">Remove the output-folder <code>metadata</code> file; aggregator discovers…</a> |
...
| 2026-09-08 | issued | <a href="active/interferometer_preload_prose_nufft.md">Interferometer preload prose says "minutes to hours" — it is now…</a> |
