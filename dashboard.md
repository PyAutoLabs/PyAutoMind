...
<!-- generated by `pyauto-brain intake dashboard --apply` on 2026-09-14 — regenerate, do not hand-edit -->
...
> **Last updated 2026-09-14.** This page is generated from `active/`, `draft/` and the registry files, so it is only as current as they are. `dashboard_refresh.yml` re-renders it on every push to `main` — that heals a stale page, but not a stale prompt: a task that shipped without its prompt advancing to `complete/` keeps rendering here as pickable backlog. Reconciling those is the refresh below.
...
<details><summary>📋 <a href="active/fixed_lens_light_source_only_inversion.md">Fixed lens light after SLaM light[1]: cost of the source-only pixelized inversion…</a> — <a href="https://github.com/PyAutoLabs/autolens_profiling/issues/248">issue #248</a> — issued 2026-09-12 — awaiting-merge (PR open under Heart RED with human authorisation 2026-09-13; merge is human) — PRs: <a href="https://github.com/PyAutoLabs/autolens_profiling/pull/250">autolens_profiling#250</a></summary>
...
<details><summary>📋 <a href="active/fixed_light_likelihood_assessment_hst_euclid.md">Fixed lens light — whole-likelihood assessment on HST and Euclid at 500…</a> — <a href="https://github.com/PyAutoLabs/autolens_profiling/issues/259">issue #259</a> — issued 2026-09-13 — awaiting-merge (PR open under Heart RED with human authorisation 2026-09-13; merge is human, and stacked PRs #250, #252, #254… — PRs: <a href="https://github.com/PyAutoLabs/autolens_profiling/pull/260">autolens_profiling#260</a></summary>

```
/start_dev active/fixed_light_likelihood_assessment_hst_euclid.md
```

</details>

<details><summary>📋 <a href="active/fixed_light_source_pixel_scaling.md">Fixed lens light — source-pixel scaling of the new approach across hardware</a> — <a href="https://github.com/PyAutoLabs/autolens_profiling/issues/257">issue #257</a> — issued 2026-09-13 — awaiting-merge (PR open under Heart RED with human authorisation 2026-09-13; merge is human, and stacked PRs #250, #252, #254… — PRs: <a href="https://github.com/PyAutoLabs/autolens_profiling/pull/258">autolens_profiling#258</a></summary>

```
/start_dev active/fixed_light_source_pixel_scaling.md
```

</details>

<details><summary>📋 <a href="active/fixed_light_unconstrained_library_path.md">Fixed lens light — library-path timing of the S3 positive-negative and certified…</a> — <a href="https://github.com/PyAutoLabs/autolens_profiling/issues/251">issue #251</a> — issued 2026-09-13 — awaiting-merge (PR open under Heart RED with human authorisation 2026-09-13; merge is human, and stacked PR #250 merges first) — PRs: <a href="https://github.com/PyAutoLabs/autolens_profiling/pull/252">autolens_profiling#252</a></summary>
...
<details><summary>📋 <a href="active/howtofit_mode.md">autofit_assistant: HowToFit learning mode</a> — <a href="https://github.com/PyAutoLabs/autofit_assistant/issues/42">issue #42</a> — issued 2026-09-14 — workspace-dev</summary>

```
/start_dev active/howtofit_mode.md
```
...
<details><summary>📋 <a href="active/model_figure_prose_simplify.md">Model figure prose: replace the map/legend block with two short paragraphs</a> — <a href="https://github.com/PyAutoLabs/autofit_workspace/issues/156">issue #156</a> — issued 2026-09-14 — PRs OPEN (6), awaiting CI + /prm; Heart YELLOW acknowledged by the human 2026-09-14 — PRs: <a href="https://github.com/PyAutoLabs/PyAutoFit/pull/1627">PyAutoFit#1627</a>, <a href="https://github.com/PyAutoLabs/PyAutoGalaxy/pull/617">PyAutoGalaxy#617</a>, <a href="https://github.com/PyAutoLabs/PyAutoLens/pull/738">PyAutoLens#738</a>, <a href="https://github.com/PyAutoLabs/autofit_workspace/pull/158">autofit_workspace#158</a>, <a href="https://github.com/PyAutoLabs/HowToFit/pull/56">HowToFit#56</a>, <a href="https://github.com/PyAutoLabs/autogalaxy_workspace/pull/241">autogalaxy_workspace#241</a></summary>
...
**182** filed prompts, not started. Each section is sorted most-pickable first (priority, then size). **34** of them belong to an epic and are listed only under [Epics](#epics) below.
...
<details><summary>📋 <a href="draft/bug/autohands/generate_markdown_leaks_worktree_paths.md">generate_markdown.py leaks local paths when run from a task worktree</a> — autohands · small · supervised · medium</summary>

```
/start_dev draft/bug/autohands/generate_markdown_leaks_worktree_paths.md
```
...
<details><summary>📋 <a href="draft/bug/howtofit/tutorial_3_uninitialised_emcee_is_flaky.md">HowToFit tutorial 3: the uninitialised Emcee fit does not reliably succeed</a> — howtofit · small · supervised · normal</summary>

```
/start_dev draft/bug/howtofit/tutorial_3_uninitialised_emcee_is_flaky.md
```
...
<details><summary>📋 <a href="draft/docs/workspaces/howto_paths_orientation_block_parity.md">HowToGalaxy and HowToLens have no <code>__Paths__</code> orientation block</a> — workspaces · small · supervised · low</summary>

```
/start_dev draft/docs/workspaces/howto_paths_orientation_block_parity.md
```
...
<details><summary>📋 <a href="draft/docs/howtofit/markdown_mirror_missed_by_url_fix.md">HowToFit: the tutorial_1 markdown mirror was missed by the download-URL fix</a> — howtofit · trivial · safe · low</summary>

```
/start_dev draft/docs/howtofit/markdown_mirror_missed_by_url_fix.md
```
...
<details>
<summary><b>graphical-ep</b> — 3 task(s) · 4 pts · auto — proposed — ⚠️ theme(s) not in `themes.md`: tutorials</summary>
...
Members:
- draft/bug/graphical_ep/ep_use_cpu_flag_disables_jax.md
...
|--------|------|------------|----------|--------|
| <a href="draft/bug/graphical_ep/ep_use_cpu_flag_disables_jax.md">slope_hierarchy_scale <code>--use_cpu</code> must not disable the JAX likelihood</a> | graphical_ep | small | high | formalised |
...
| 2026-09-14 | filed | <a href="draft/bug/autohands/generate_markdown_leaks_worktree_paths.md">generate_markdown.py leaks local paths when run from a task worktree</a> |
...
| Date | Event | Task |
|------|-------|------|
| 2026-09-14 | filed | <a href="draft/bug/howtofit/tutorial_3_uninitialised_emcee_is_flaky.md">HowToFit tutorial 3: the uninitialised Emcee fit does not reliably…</a> |
...
<details>
<summary><b>Fixed lens light — source-only likelihood profiling programme</b> — 1 queued prompt(s), in order</summary>
...
- `draft/bug/autohands/generate_markdown_leaks_worktree_paths.md — unknown theme keyword(s): build, docs`
...
- `draft/bug/howtofit/tutorial_3_uninitialised_emcee_is_flaky.md — unknown theme keyword(s): howtofit, mcmc, flaky`
...
- `draft/docs/howtofit/markdown_mirror_missed_by_url_fix.md — unknown theme keyword(s): howto, tutorials`
