...
<details><summary>📋 <a href="draft/feature/pyautobrain/organ_cockpit_phase_1_state_json_feed.md">Organ cockpit phase 1: state.json feed schema and Heart transition alert</a> — pyautobrain · large · safe · high</summary>

```
/start_dev draft/feature/pyautobrain/organ_cockpit_phase_1_state_json_feed.md
```
