...
<details><summary>📋 <a href="active/cortex_batch_member_kind.md">Cortex phase 5 — the second batch member kind: separate records, separate…</a> — <a href="https://github.com/PyAutoLabs/PyAutoBrain/issues/334">issue #334</a> — issued 2026-09-02 — library-shipped, awaiting-merge</summary>

```
/start_dev active/cortex_batch_member_kind.md
```
...
**159** filed prompts, not started. Each section is sorted most-pickable first (priority, then size). **50** of them belong to an epic and are listed only under [Epics](#epics) below.
...
| Date | Event | Task |
|------|-------|------|
| 2026-09-02 | issued | <a href="active/cortex_batch_member_kind.md">Cortex phase 5 — the second batch member kind: separate records…</a> |
...
<details>
<summary><b>PyAutoCortex — the science organ: split science runs out of the Mind</b> — 2 queued prompt(s), in order</summary>

<details><summary>📋 <b>PyAutoCortex — the science organ: split science runs out of the Mind</b> — ledger: `draft/feature/pyautocortex/cortex_birth_epic.md` — phases 0–4 SHIPPED 2026-09-01 (#377, #379, #380, #382, #383; records complete/2026/09/cortex-birth-organ-row.md…</summary>
