...
<details><summary>📋 <a href="draft/bug/autofit/joint_clipper_compose_with_bijector.md">Compose ClipperPriorBoxJoint with a bijector/scaler instead of refusing it</a> — autofit · medium · supervised · normal</summary>

```
/start_dev draft/bug/autofit/joint_clipper_compose_with_bijector.md
```
