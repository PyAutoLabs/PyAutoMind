...
```
/start_dev draft/bug/autolens/vis_lp_mge_stage_writes_no_latents.md
```
...
<details><summary>📋 <a href="draft/research/autolens_profiling/a100_pixelized_likelihood_baseline_for_matrix_free.md">Final A100 fp64 baseline of the pixelized imaging likelihood…</a> — autolens_profiling · large · supervised · high</summary>

```
/start_dev draft/research/autolens_profiling/a100_pixelized_likelihood_baseline_for_matrix_free.md
```
...
<details>
<summary><b>jax-gpu · performance · hpc</b> — 2 task(s) · 5 pts · auto — proposed — ⚠️ theme(s) not in `themes.md`: hpc, jax-gpu, performance</summary>

<details><summary>📋 <b>Run this bundle</b> — one session, one issue and one PR per member</summary>

```
You are the architect (Fable) for the PyAutoMind bundle 'jax-gpu · performance · hpc' — 2 INDEPENDENT tasks run in one orchestrated session.

Members:
- draft/research/autolens_profiling/a100_pixelized_likelihood_baseline_for_matrix_free.md
...
|--------|------|------------|----------|--------|
| <a href="draft/research/autolens_profiling/a100_pixelized_likelihood_baseline_for_matrix_free.md">Final A100 fp64 baseline of the pixelized imaging likelihood…</a> | autolens_profiling | large | high | formalised |
...
| 2026-09-10 | filed | <a href="draft/research/autolens_profiling/a100_pixelized_likelihood_baseline_for_matrix_free.md">Final A100 fp64 baseline of the pixelized imaging likelihood…</a> |
...
- `draft/research/autolens_profiling/a100_pixelized_likelihood_baseline_for_matrix_free.md — unknown theme keyword(s): jax-gpu, performance, hpc`
