...
<details><summary>📋 <a href="active/physical_fast_rebuild_autogalaxy.md">autogalaxy_workspace_test physical + fast rebuild (rehearsal repo)</a> — <a href="https://github.com/PyAutoLabs/autogalaxy_workspace_test/issues/116">issue #116</a> — issued 2026-09-06 — workspace-dev</summary>
...
**153** filed prompts, not started. Each section is sorted most-pickable first (priority, then size). **30** of them belong to an epic and are listed only under [Epics](#epics) below.
