...
**165** filed prompts, not started. Each section is sorted most-pickable first (priority, then size). **49** of them belong to an epic and are listed only under [Epics](#epics) below.
...
<details><summary>📋 <a href="draft/feature/pyautobrain/batch_board.md">Batch phase 6 — the batch status box on the Mind…</a> — pyautobrain · medium · safe</summary>
