...
**218** filed prompts, not started. Each section is sorted most-pickable first (priority, then size). **37** of them belong to an epic and are listed only under [Epics](#epics) below.
...
<details><summary>📋 <a href="draft/docs/autolens_workspace/trim_external_shear_narrative.md">Trim external-shear narrative from workspace examples</a> — autolens_workspace · small · supervised · normal</summary>

```
/start_dev draft/docs/autolens_workspace/trim_external_shear_narrative.md
```
...
| 2026-09-19 | filed | <a href="draft/docs/autolens_workspace/trim_external_shear_narrative.md">Trim external-shear narrative from workspace examples</a> |
...
- `draft/docs/autolens_workspace/trim_external_shear_narrative.md — unknown theme keyword(s): mass-field`
