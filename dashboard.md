...
**180** filed prompts, not started. Each section is sorted most-pickable first (priority, then size). **36** of them belong to an epic and are listed only under [Epics](#epics) below.
...
<details>
<summary><b>Fixed lens light — source-only likelihood profiling programme</b> — 2 queued prompt(s), in order</summary>
