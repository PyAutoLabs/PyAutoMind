...
<details><summary>📋 <a href="draft/docs/autolens_workspace/remove_empty_modeling_headings.md">Remove empty modeling headings from workspace examples</a> — autolens_workspace · small · supervised · normal</summary>

```
/start_dev draft/docs/autolens_workspace/remove_empty_modeling_headings.md
```
...
| Date | Event | Task |
|------|-------|------|
| 2026-09-20 | filed | <a href="draft/docs/autolens_workspace/remove_empty_modeling_headings.md">Remove empty modeling headings from workspace examples</a> |
| 2026-09-19 | issued | <a href="parked.md#catalogue-inspection-before-vis-pix">catalogue-inspection-before-vis-pix</a> |
| 2026-09-19 | issued | <a href="active/org_community_guidance_hub.md">Publish organization community guidance and welcome</a> |
| 2026-09-19 | issued | <a href="active/org_community_guidance_and_welcome.md">Make organization-wide community guidance visible and canonical</a> |
...
- `draft/docs/autolens_workspace/remove_empty_modeling_headings.md — unknown theme keyword(s): mass-field`
