...
<details><summary>📋 <a href="active/jax_grad_delaunay_fd_sweep_repin.md">imaging/jax_grad/delaunay.py: FD step sweep sits in the round-off floor on mass.ell_comps_0 after…</a> — issued 2026-09-07</summary>

```
/start_dev active/jax_grad_delaunay_fd_sweep_repin.md
```
...
| Date | Event | Task |
|------|-------|------|
| 2026-09-07 | issued | <a href="active/jax_grad_delaunay_fd_sweep_repin.md">imaging/jax_grad/delaunay.py: FD step sweep sits in the round-off…</a> |
