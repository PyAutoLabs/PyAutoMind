...
<details><summary>📋 <a href="active/batch_board.md">Batch phase 6 — the batch status box on the Mind…</a> — issued 2026-09-02</summary>
...
**163** filed prompts, not started. Each section is sorted most-pickable first (priority, then size). **49** of them belong to an epic and are listed only under [Epics](#epics) below.
...
<details>
<summary><b>Fixed-geometry deflection memo — rescale Gaussians by the free mass-to-light ratio (numpy + JAX)</b> — 4 queued prompt(s), in order</summary>

<details><summary>📋 <b>Fixed-geometry deflection memo — rescale Gaussians by the free mass-to-light ratio (numpy + JAX)</b> — ledger: `draft/feature/autogalaxy/precompute_fixed_geometry_gaussian_deflections.md` — phase 1 in flight 2026-09-03</summary>
...
<details><summary>📋 <a href="draft/feature/autogalaxy/gaussian_precompute_p1_numpy_memo.md">Gaussian precompute phase 1: numpy deflection memo — fixed-geometry whole field, <code>mass_to_light_ratio</code>…</a> — autogalaxy · medium · supervised · medium</summary>

```
/start_dev draft/feature/autogalaxy/gaussian_precompute_p1_numpy_memo.md
```
...
- `draft/feature/autogalaxy/gaussian_precompute_p1_numpy_memo.md`
...
- `draft/feature/autogalaxy/gaussian_precompute_p1_numpy_memo.md — unknown theme keyword(s): mass-profiles`
