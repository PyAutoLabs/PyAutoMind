...
<details><summary>📋 <a href="active/add_an_abell_1201_central_point_mass.md">Abell 1201 guided SMBH demonstration and Gemini Colab follow-on</a> — <a href="https://github.com/PyAutoLabs/autolens_assistant/issues/133">issue #133</a> — issued 2026-09-22 — awaiting-input — PRs: <a href="https://github.com/PyAutoLabs/autolens_assistant/pull/134">autolens_assistant#134</a></summary>
...
<details><summary>📋 <a href="active/interferometer_mge_breakdown_jax_cpu_gpu.md">Interferometer likelihood campaign 1/3: MGE breakdown on JAX CPU and A100 GPU…</a> — <a href="https://github.com/PyAutoLabs/autolens_profiling/issues/308">issue #308</a> — issued 2026-09-25 — workspace-dev</summary>
...
**231** filed prompts, not started. Each section is sorted most-pickable first (priority, then size). **48** of them belong to an epic and are listed only under [Epics](#epics) below.
...
<details><summary>📋 <a href="draft/feature/autolens_assistant/cosmos_web_ring_greeting.md">COSMOS-Web Ring greeting: replace the Abell 1201 demonstration on the website, benchmark…</a> — autolens_assistant · large · supervised · high</summary>

```
/start_dev draft/feature/autolens_assistant/cosmos_web_ring_greeting.md
```
...
<details>
<summary><b>assistant</b> — 2 task(s) · 6 pts · auto — proposed — ⚠️ theme(s) not in `themes.md`: assistant, benchmarks, colab, support-policy, website</summary>

<details><summary>📋 <b>Run this bundle</b> — one session, one issue and one PR per member</summary>

```
You are the judgment tier for the PyAutoMind bundle 'assistant' — 2 INDEPENDENT tasks run in one orchestrated session.

Members:
- draft/feature/autolens_assistant/cosmos_web_ring_greeting.md
...
| Prompt | Repo | Difficulty | Priority | Status |
|--------|------|------------|----------|--------|
| <a href="draft/feature/autolens_assistant/cosmos_web_ring_greeting.md">COSMOS-Web Ring greeting: replace the Abell 1201 demonstration on the…</a> | autolens_assistant | large | high | draft |
...
| Date | Event | Task |
|------|-------|------|
| 2026-09-26 | filed | <a href="draft/feature/autolens_assistant/cosmos_web_ring_greeting.md">COSMOS-Web Ring greeting: replace the Abell 1201 demonstration on the…</a> |
...
59 prompt(s) with unknown theme keyword(s) — not in [`themes.md`](themes.md), so they group loudly rather than silently. Correct the prompt, or add the keyword to the vocabulary.
...
- `draft/feature/autolens_assistant/cosmos_web_ring_greeting.md — unknown theme keyword(s): assistant, benchmarks, website, colab`
