...
<details><summary>📋 <a href="active/cortex_project_remotes_and_registration.md">Cortex phase 3 — private remotes for the Science-folder projects…</a> — <a href="https://github.com/PyAutoLabs/PyAutoMind/issues/382">issue #382</a> — issued 2026-09-01 — workspace-dev</summary>

```
/start_dev active/cortex_project_remotes_and_registration.md
```
...
**166** filed prompts, not started. Each section is sorted most-pickable first (priority, then size). **59** of them belong to an epic and are listed only under [Epics](#epics) below.
...
| Date | Event | Task |
|------|-------|------|
| 2026-09-01 | issued | <a href="active/cortex_project_remotes_and_registration.md">Cortex phase 3 — private remotes for the Science-folder projects…</a> |
...
<details>
<summary><b>PyAutoCortex — the science organ: split science runs out of the Mind</b> — 4 queued prompt(s), in order</summary>

<details><summary>📋 <b>PyAutoCortex — the science organ: split science runs out of the Mind</b> — ledger: `draft/feature/pyautocortex/cortex_birth_epic.md` — phases 0–2 SHIPPED 2026-09-01 (#377, #379, #380; records complete/2026/09/cortex-birth-organ-row.md…</summary>
