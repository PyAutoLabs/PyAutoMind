...
**131** filed prompts, not started. Each section is sorted most-pickable first (priority, then size). **25** of them belong to an epic and are listed only under [Epics](#epics) below.
...
<details><summary>📋 <a href="draft/bug/ci/pages_dashboard_publish_gap.md">The Mind board goes stale precisely when the render is correct…</a> — ci · low · supervised · high</summary>

```
/start_dev draft/bug/ci/pages_dashboard_publish_gap.md
```
...
| Date | Event | Task |
|------|-------|------|
| 2026-08-27 | issued | <a href="active/rectangular_experiments_gut_stash.md">autolens_workspace_developer rectangular experiments — Gut stash +…</a> |
...
| 2026-08-27 | filed | <a href="draft/bug/ci/pages_dashboard_publish_gap.md">The Mind board goes stale precisely when the render is correct…</a> |
