...
<details><summary>📋 <a href="draft/bug/pyautoheart/colab_gate_rehearsal_audits_released_bootstrap.md">Check F audits the released Colab bootstrap in a TestPyPI rehearsal, not…</a> — pyautoheart · moderate · supervised · high</summary>

```
/start_dev draft/bug/pyautoheart/colab_gate_rehearsal_audits_released_bootstrap.md
```
...
<details>
<summary><b>pyautoheart — bundle 1</b> — 4 task(s) · 7 pts · auto — proposed</summary>

<details><summary>📋 <b>Run this bundle</b> — one session, one issue and one PR per member</summary>

```
You are the architect (Fable) for the PyAutoMind bundle 'pyautoheart — bundle 1' — 4 INDEPENDENT tasks run in one orchestrated session.

Members:
- draft/bug/pyautoheart/colab_gate_rehearsal_audits_released_bootstrap.md
...
|--------|------------|----------|--------|
| <a href="draft/bug/pyautoheart/colab_gate_rehearsal_audits_released_bootstrap.md">Check F audits the released Colab bootstrap in a TestPyPI rehearsal…</a> | moderate | high | formalised |
