...
<details>
<summary><b>Intermittent XLA compile stall in the JAX vmap likelihood path</b> — 4 queued prompt(s), in order</summary>
...
<details><summary>📋 <a href="draft/bug/ci/jax_compile_stall_3_root_cause.md">Phase 3: root-cause the JAX likelihood hang and clear every NEEDS_FIX…</a> — ci · large · supervised · high</summary>
...
<details><summary>📋 <a href="draft/bug/ci/jax_compile_stall_4_exclusion_census.md">Phase 4: census and reconcile every excluded script across both test workspaces</a> — ci · medium · supervised · high</summary>

```
/start_dev draft/bug/ci/jax_compile_stall_4_exclusion_census.md
```
...
<details><summary>📋 <a href="draft/bug/ci/smoke_runner_retry_on_timeout.md">Retry a timed-out script once in the shared runner, before failing…</a> — ci · small · supervised · low</summary>
