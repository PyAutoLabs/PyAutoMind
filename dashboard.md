...
**173** filed prompts, not started. Each section is sorted most-pickable first (priority, then size). **33** of them belong to an epic and are listed only under [Epics](#epics) below.
...
| 2026-09-11 | issued | <a href="active/model_figures_3_lens_cookbook.md">Model figures phase 3 — lens semantics and cookbooks</a> |
