...
<details><summary>📋 <a href="draft/feature/autoarray/certified_solver_scalar_default_flip.md">Certified positive solver — flip the scalar JAX default to certified +…</a> — autoarray · small · supervised · high</summary>

```
/start_dev draft/feature/autoarray/certified_solver_scalar_default_flip.md
```
...
- `draft/feature/autoarray/certified_solver_scalar_default_flip.md — unknown theme keyword(s): inversion`
