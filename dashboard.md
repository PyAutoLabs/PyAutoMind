...
<details><summary>📋 <a href="active/cortex_dashboard_projects_first.md">Cortex dashboard: projects first, check-in prompt on top, epics discarded</a> — issued 2026-09-04</summary>

```
/start_dev active/cortex_dashboard_projects_first.md
```
...
| 2026-09-04 | issued | <a href="active/cortex_dashboard_projects_first.md">Cortex dashboard: projects first, check-in prompt on top, epics…</a> |
