...
<details><summary>📋 <a href="draft/feature/pyautobrain/batch_review_integration_branches.md">Batch review: opt-in integration branches so a reviewer can run the whole…</a> — pyautobrain · large · supervised · medium</summary>

```
/start_dev draft/feature/pyautobrain/batch_review_integration_branches.md
```
...
<details><summary>📋 <a href="active/analytic_gaussian_benchmark.md">Analytic Gaussian benchmark: closed-form validation of graphical + EP</a> — <a href="https://github.com/PyAutoLabs/autofit_workspace_test/issues/91">issue #91</a> — issued 2026-09-02 — workspace-dev</summary>
...
<details><summary>📋 <a href="active/numpy_deflections_p1_sph_decorator_tracer.md">Numpy deflections phase 1: measure (scripts/lens), fix the *Sph over-sampled re-materialisation, drop…</a> — <a href="https://github.com/PyAutoLabs/PyAutoArray/issues/514">issue #514</a> — issued 2026-09-02 — library-dev</summary>
...
**160** filed prompts, not started. Each section is sorted most-pickable first (priority, then size). **47** of them belong to an epic and are listed only under [Epics](#epics) below.
