...
<!-- generated by `pyauto-brain intake dashboard --apply` on 2026-08-09 — regenerate, do not hand-edit -->

**144** filed prompts in the backlog · **6** already dispatched to issues (`active/`). Backlog view only — organism health lives with the Heart (`/health`), not here.
...
| [The `al.SimulatorInterferometer` path that uses `al.TransformerNUFFT` (nufftax-backed) can't scale to](draft/feature/autoarray/nufft_simulator_chunking.md) | autoarray | small | supervised | high |
