...
<details><summary>📋 <a href="active/finish_the_science_project_memory_propagation_au.md">Finish the science-project memory propagation: autofit_assistant sync and autocti_assistant birth-substitution gaps</a></summary>

```
/start_dev active/finish_the_science_project_memory_propagation_au.md
```
...
**143** filed prompts, not started. Each section is sorted most-pickable first (priority, then size). **36** of them belong to an epic and are listed only under [Epics](#epics) below.
...
<details>
<summary><b>ci-smoke</b> — 3 task(s) · 7 pts · auto — proposed</summary>

<details><summary>📋 <b>Run this bundle</b> — one session, one issue and one PR per member</summary>

```
You are the architect (Fable) for the PyAutoMind bundle 'ci-smoke' — 3 INDEPENDENT tasks run in one orchestrated session.
...
| Prompt | Repo | Difficulty | Priority | Status |
|--------|------|------------|----------|--------|
| <a href="draft/test/autolens/cross_validate_multi_plane_ray_tracing.md">Cross-validate multi-plane ray tracing</a> | autolens | large | high | formalised |
| <a href="draft/maintenance/workspaces/unpark_imaging_scaling_relation_slam.md">Un-park imaging/features/scaling_relation/slam — the PyAutoArray#431…</a> | workspaces | small | normal | formalised — ready to start (upstream… |
...
| 2026-08-28 | issued | <a href="active/anonymise_the_named_science_target_in_the.md">Anonymise the named science target in the WFC3-IR hole regression</a> |
...
<details>
<summary><b>Euclid DR1 preparation — 15k-lens modelling prep</b> — 11 queued prompt(s), in order</summary>
...
<details><summary>📋 <a href="draft/feature/autolens/cmap_magma_default.md">Colormap control: audit the cmap lever end-to-end and default the Euclid configs…</a> — autolens · small-medium · safe · high</summary>

```
/start_dev draft/feature/autolens/cmap_magma_default.md
```

</details>

<details><summary>📋 <a href="draft/feature/euclid/pipeline_parity_with_science_euclid.md">Pipeline parity: port the DR1 analysis from Science/euclid into euclid_strong_lens_modeling_pipeline</a> — euclid · large · supervised · high</summary>

```
/start_dev draft/feature/euclid/pipeline_parity_with_science_euclid.md
```
...
- `draft/feature/autolens/cmap_magma_default.md — unknown theme keyword(s): euclid`
...
- `draft/feature/euclid/pipeline_parity_with_science_euclid.md — unknown theme keyword(s): euclid`
