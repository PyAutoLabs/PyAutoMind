...
<details><summary>📋 <a href="draft/feature/pyautobrain/cortex_checkin_p2_the_door.md"><code>/cortex</code> — the one check-in door: pull every active project, score, render…</a> — pyautobrain · medium · supervised · high</summary>

```
/start_dev draft/feature/pyautobrain/cortex_checkin_p2_the_door.md
```
