...
<!-- generated by `pyauto-brain intake dashboard --apply` on 2026-09-24 — regenerate, do not hand-edit -->
...
> **Last updated 2026-09-24.** This page is generated from `active/`, `draft/` and the registry files, so it is only as current as they are. `dashboard_refresh.yml` re-renders it on every push to `main` — that heals a stale page, but not a stale prompt: a task that shipped without its prompt advancing to `complete/` keeps rendering here as pickable backlog. Reconciling those is the refresh below.
...
<details><summary>📋 <a href="active/certified_solver_phase_c1_lane_rate.md">Certified solver phase C1 — uncertified-lane rate and batched timing on real…</a> — <a href="https://github.com/PyAutoLabs/autolens_profiling/issues/304">issue #304</a> — issued 2026-09-24 — workspace-dev</summary>
...
<details><summary>📋 <a href="active/hst_gpu_residue_p4_logdet_cholesky_reuse.md">HST GPU residue phase 4 — reuse the certified solve's Cholesky…</a> — <a href="https://github.com/PyAutoLabs/autolens_profiling/issues/303">issue #303</a> — issued 2026-09-24 — awaiting-merge — PRs: <a href="https://github.com/PyAutoLabs/autolens_profiling/pull/306">autolens_profiling#306</a></summary>
...
<details><summary>📋 <a href="draft/feature/euclid/euclid_dr1_sanitise_positions_json_drop_central.md">euclid_dr1: sanitise positions.json (drop central/spurious multiple images) before modelling</a> — euclid · too-large · supervised · high</summary>

```
/start_dev draft/feature/euclid/euclid_dr1_sanitise_positions_json_drop_central.md
```
...
- `draft/feature/euclid/euclid_dr1_sanitise_positions_json_drop_central.md — unknown theme keyword(s): euclid, hpc`
