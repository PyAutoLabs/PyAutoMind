...
| 11 | `draft/maintenance/autolens_profiling/mass_field_live_builders.md` then `mass_field_pipeline_resume.md` | autolens_profiling | Live profiling builders; preserve inline witness snapshots. | Human waiver recorded 2026-09-19 for a separate worktree; staged pipeline still waits on phase 7 publication. |
