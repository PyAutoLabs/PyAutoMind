...
| 8 | active/user_workspace_howto_slow_script_pass.md | **in flight** — issued 2026-09-06, autolens_workspace#536 (14 scripts ≥ 10 s across autolens_workspace / HowToLens / HowToGalaxy / autogalaxy_workspace; the local-vs-CI gap on the pixelization tutorials is task 1); autocti's 61 s `imaging_ci/modeling/start_here.py` split out as phase 8b `draft/test/autocti_workspace/imaging_ci_start_here_61s.md` |
