...
Reuse the separate active CPU decomposition task PyAutoMind/active/fixed_light_numba_phase1_whole_call.md and its draft fixed_light_numba_cpu_programme.md; do not duplicate that campaign or the hst_gpu_non_solver_residue_programme.md.
