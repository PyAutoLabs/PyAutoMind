...
Reuse the separate active CPU decomposition task PyAutoMind/complete/2026/09/fixed-light-numba-phase1.md (and its phase-2 successor complete/2026/09/fixed-light-numba-solver.md) and its draft fixed_light_numba_cpu_programme.md; do not duplicate that campaign or the hst_gpu_non_solver_residue_programme.md.
