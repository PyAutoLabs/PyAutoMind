...
| 1 | Library-path timing of the S3 positive-negative and certified active-set solvers (A100, HST) | `active/fixed_light_unconstrained_library_path.md` (autolens_profiling #251) | phase 0 note landed | **issued #251** 2026-09-13 — branch `feature/fixed-light-library-path`, stacked on phase 0's `feature/fixed-lens-light-source-only` |
