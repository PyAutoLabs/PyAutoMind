...
Autonomy: safe
Priority: low
Status: in progress — autolens_assistant leg shipped 2026-07-25 (autolens_assistant#91); autogalaxy leg UNBLOCKED and still undone (2026-09-14: `autogalaxy_assistant/` now exists, but carries no regime routing)
Consequence: notify
