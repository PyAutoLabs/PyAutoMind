...
| 2026-07-10 | per-frame-psf (#21) | supervised | tests 181 pass + real-data 3/3 frames viable / smoke n-a (no downstream consumer) / review pending / heart pending (gate completes at ship) | parked (ship sign-off on issue #21) |
| 2026-07-10 | prior-width-safety (PyAutoFit#1346) | supervised | tests 1447 pass/14 skip (full suite) / smoke queued at PR-open / review CLEAN (D2 strict->permissive amendment disclosed on issue) / heart YELLOW within live 6-reason ack | PR-open (PyAutoFit#1348) |
