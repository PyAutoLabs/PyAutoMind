...
| 2026-07-10 | priors-messages-fixes (PyAutoFit#1344) | supervised | tests 1437 pass/14 skip (full suite) / smoke priors_xp_dispatch PASS + emcee_bias running at PR-open / review CLEAN (Fable math re-verification in-session) / heart YELLOW-acked live (6-reason set) | PR-open (PyAutoFit#1345) |
