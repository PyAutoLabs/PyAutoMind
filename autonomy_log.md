...
| 2026-07-09 | lenstool-example (autolens_workspace#239) | supervised | tests in-run verification (0.068" parity vs published model; 72-param composition assert) / smoke data.py + modeling.py end-to-end / review CLEAN / heart-ack carried in-session | PR-open (autolens_workspace#240) |
