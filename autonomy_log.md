...
| 2026-07-09 | cluster-visualization (PyAutoLens#577) | supervised | tests 6 new + 342 suite / smoke integration script end-to-end (per-plane physics assert) / review CLEAN / heart YELLOW-acked in-session | PR-open (#578, awt#152) |
| 2026-07-09 | cluster-scaling-lenstool (autolens_workspace#237) | supervised | tests structural (N=12 + anchoring asserts; workspace repo) / smoke simulator end-to-end on new truth / review CLEAN / heart YELLOW-acked in-session | PR-open (autolens_workspace#238) |
