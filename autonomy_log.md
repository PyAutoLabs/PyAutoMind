...
| 2026-07-09 | point-pairing-policies (PyAutoLens#585) | supervised | tests 5 new regressions + 358 suite / smoke guide end-to-end / review CLEAN / heart-ack carried in-session | PR-open (#586, autolens_workspace#248; default-policy decision batched) |
...
| 2026-07-09 | cluster-small-datasets (autolens_workspace#249) | supervised | tests timed evidence 24s/26s/2s/175s under authoritative sweep env from clean regen / smoke = the evidence itself / review CLEAN / heart-ack carried | PR-open (autolens_workspace#250 + PyAutoBuild#123) |
...
| 2026-07-09 | csv-api-lenstool (PyAutoGalaxy#490) | supervised | tests 12 new + 962 suite / smoke lenstool example end-to-end at identical 0.0680" parity post-port / review CLEAN / heart-ack carried | PR-open (#491 + autolens_workspace#252 stacked on #250; loud-guard decision batched) |
