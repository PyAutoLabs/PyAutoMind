...
| 2026-07-10 | slacs1430-acs-parity (PyAutoReduce#17) | safe | tests 187 pass (suite on branch) / smoke n-a (scripts-only) / review n-a (analysis artefacts, package untouched) / heart n-a (human-directed close-out, not unattended) | parked (PR#23 open at close-out; model-parity fits checkpointed, issue stays open) |
