...
- status: phase 1 SHIPPED 2026-09-02 — PyAutoArray#517 merged, issue #515 closed, record `complete/2026/09/image-source-mappings-p1.md`; `pending-release`, so phase 2 stays blocked on the PyAutoArray release (human's call to open)
