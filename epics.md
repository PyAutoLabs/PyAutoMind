...
- status: phase 0 issued 2026-09-25 as PyAutoMind#437 (pivot from the retired `autolens-visualization` task, PyAutoMind#436); repo rename + org-profile row are human acts
