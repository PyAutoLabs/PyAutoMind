...
- status: parked-resumable (user end-of-day 2026-07-09) — phases 0-2 done (pixel parity: data ratio 1.04; legacy noise lacks R=1.364 while slacs0008 legacy had it; legacy frame is rot270 of north-up, no mirror; acquire duplicate-exposure bug filed bug/pyautoreduce/acquire_duplicate_exposure_families.md, workaround = cache-manifest surgery already applied); phase 3 fits checkpointed mid-sampling — OOM lesson: ~5.5GB each, run ONE at a time
