...
- workspace-pr: https://github.com/PyAutoLabs/autolens_workspace/pull/566 (head acec7e8a; pending-release)
- validation: 37/37 smoke scripts and 2/2 notebooks passed locally; PyAutoHands allowlist/release-smoke tests 15 passed; review CLEAN; Heart STALE (no fresh rehearsal for current source). PR CI pending at open.
