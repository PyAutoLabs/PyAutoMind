...
- issued: 2026-08-29
- status: library-shipped, awaiting-merge (PyAutoGalaxy PR open; PyAutoLens test-only PR opens after it merges)
- library-pr: https://github.com/PyAutoLabs/PyAutoGalaxy/pull/593
