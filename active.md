...
- status: workspace-dev
- hpc: "CPU job 343394 (fl_numba_s4) SUBMITTED 2026-09-17 15:37 BST from RAL worktree /mnt/ral/jnightin/autolens_profiling_wt/fixed-light-numba-s4 @ c7b72f6 (gpu partition CPUs-only, euclid-ral-gpu-1, one 1-CPU neighbour 343391_0 at start; lensed_source.fits pre-seeded from the levers worktree, md5 d15c4ce9); routes b,b_direct,b_touched --n-repeats 64 then the s4 witness; WALL-BASIS ~2 h. HARVEST: commit results/breakdown/imaging/fixed_light_numba_delaunay_hpc_ral_cpu_fp64_fixed_light_numba_s4_b_warm_t1.{json,png} + fixed_light_numba_s4_witness_hpc_ral_cpu_fp64_s4.json in the RAL worktree, fetch locally, read rows.*.call_ms on all three rows with ABBA + overhead PASS and seed_source memo, apply the >= 5 % whole-call rule; output/ error/ logs in hpc/batch_cpu/ of the RAL worktree."
...
- note: "Phase 4 of fixed-lens-light-numba-cpu. Two waves, sequential PRs, never stacked (#267 lesson). WAVE A 2026-09-17 15:40: branch feature/fixed-light-numba-s4 PUSHED @ c7b72f6 (six commits: e0ca612 ms-budget overhead gate MAX_INSTRUMENTATION_OVERHEAD_MS=12, f88b9e0 fixed_light_numpy_kernels.py seam, 8998ec9 routes b_direct/b_touched, 960db5d s4 witness, 635a83d batch_cpu s4 submit + WALL-BASIS, c7b72f6 route-table alignment); laptop Verification block green (42 tests, ruff, build_readme/check_submits, cell 6 repeats wiring-only, witness PASS: W2 direct 4e-13 rel / touched bit-identical, W3 1e-15 rel; laptop W4 site medians have both candidates slower than two-stage, RECORDED only); RAL job 343394 running (see hpc). RESUME after harvest: note results/notes/fixed_lens_light_s4_2026_09.md (Scope/Provenance/Gate roll-up/headline/decomposition/verdict/Next), build_readme.py regen, /ship_workspace (Heart RED install-verify/integrate -> human ack), PyAutoArray docstring PR at inversion_imaging_numba_util.py:781 (kernel change only if a candidate wins >= 5 % whole-call), /prm; wave B (A-prime) only after wave A merges. Progress comment on the issue 2026-09-17 15:38."
