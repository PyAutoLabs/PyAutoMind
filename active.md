...
- status: workspace-dev, PAUSED (user 2026-07-17) — sampling runs stopped; cold-run generation switches to PYAUTO_TEST_MODE_SAMPLES once PyAutoFit#1379 (phase 2, now active) ships. Harness pushed 9129d49+0af2d6e+96acde6 incl. test-mode readiness (output/test_mode namespacing followed; _testmode artifact suffix)
