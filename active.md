...
- summary: |
    ...
    Fix pushed to `claude/howtofit-modelplotter-duplicate-eqr6gk`; full suite
    green (2796 passed, 45 skipped). Witness (nbclient): 2 `image/png`
    outputs before, 1 after. Awaiting `/ship_library` to open the PR.
