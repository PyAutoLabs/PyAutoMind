...
- results: "All5sizes PASS;80paired comparisons;960clean+960instrumented evaluations; worst reconciliation0.265%. N4000 nearbycold/memo2137.865/1288.876ms; broad4312.031/10782.596ms.24newfiles committed705129d and pushed; PR283 open."
- next: "PR283 open with pending-release label; judge CI once, report. Merge needs separate human command and all required checks green."

- heart-red-override: |
    2026-09-18 live user: "yes I authorize that", explicitly authorizing issue #282 commit/push/PR despite Heart RED.
    ...
    Passed: 15 focused tests, Ruff/format/import/shell/submit/README checks, five RAL cells, 80 pairs, 960+960 timings, independent full review CLEAN.
    Development shipping only; no release, CI bypass or merge. Branch does not repair Heart.
