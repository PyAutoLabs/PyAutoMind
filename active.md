...
- repos:
  ...
  - PyAutoBrain: feature/codex-token-efficiency
- note: "Explicit user override permits a separate concurrent worktree despite codex-hook-parity claiming PyAutoMind and PyAutoBrain; preserve that task's branches, claims, worktree, and changes."
